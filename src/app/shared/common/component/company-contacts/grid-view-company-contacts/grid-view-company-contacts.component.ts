...
import { CompanyContactsModalComponent } from '../company-contacts-modal/company-contacts-modal.component';


@Component({
    selector: 'grid-view-company-contacts',
    templateUrl: './grid-view-company-contacts.component.html',
    styleUrls: ['./grid-view-company-contacts.component.scss']
})
export class GridViewCompanyContactsComponent extends AppComponentBase implements OnInit {
    @ViewChild('companyContactsModals', { static: true }) companyContactsModals: CompanyContactsModalComponent;
