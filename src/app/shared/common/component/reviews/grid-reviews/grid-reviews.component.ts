...
@Component({
    selector: 'grid-reviews.component',
    templateUrl: './grid-reviews.component.html',
    styleUrls: ['./grid-reviews.component.scss']
})
export class GridViewReviewsComponent extends AppComponentBase implements OnInit {
    @ViewChild('reviewsModals', { static: true }) reviewsModals: ReviewsModalComponent;
