...
import { ReviewDataModalComponent } from '../review-data-modal/review-data-modal.component';


@Component({
    selector: 'grid-view-review-data',
    templateUrl: './grid-view-review-data.component.html',
    styleUrls: ['./grid-view-review-data.component.scss']
})
export class GridViewReviewDataComponent extends AppComponentBase implements OnInit {
    @ViewChild('reviewDataModals', { static: true }) reviewDataModals: ReviewDataModalComponent;
