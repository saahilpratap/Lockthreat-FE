...
import { AssociatedPogramsModalComponent } from '../associated-pograms-modal/associated-pograms-modal.component';


@Component({
    selector: 'grid-view-associated-pograms',
    templateUrl: './grid-view-associated-pograms.component.html',
    styleUrls: ['./grid-view-associated-pograms.component.scss']
})
export class GridViewAssociatedPogramsComponent extends AppComponentBase implements OnInit {

    @ViewChild('associatedPogramsModals', { static: true }) associatedPogramsModals: AssociatedPogramsModalComponent;
