...
import { RelatedContractsModalComponent } from '../related-contracts-modal/related-contracts-modal.component';


@Component({
    selector: 'grid-view-related-contracts',
    templateUrl: './grid-view-related-contracts.component.html',
    styleUrls: ['./grid-view-related-contracts.component.scss']
})
export class GridViewRelatedContractsComponent extends AppComponentBase implements OnInit {
    @ViewChild('relatedContractsModals', { static: true }) relatedContractsModals: RelatedContractsModalComponent;
