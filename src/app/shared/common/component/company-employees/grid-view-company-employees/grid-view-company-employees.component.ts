...
import { CompanyEmployeesModalComponent } from '../company-employees-modal/company-employees-modal.component';


@Component({
    selector: 'grid-view-company-employees',
    templateUrl: './grid-view-company-employees.component.html',
    styleUrls: ['./grid-view-company-employees.component.scss']
})
export class GridViewCompanyEmployeesComponent extends AppComponentBase implements OnInit {
    @ViewChild('companyEmployeesModals', { static: true }) companyEmployeesModals: CompanyEmployeesModalComponent;
