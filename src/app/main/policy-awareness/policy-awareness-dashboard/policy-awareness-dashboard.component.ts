...
@Component({
    selector: 'policy-awareness-dashboard',
    templateUrl: './policy-awareness-dashboard.component.html',
    styleUrls: ['./policy-awareness-dashboard.component.scss']
})
export class PolicyAwarenessDashboardComponent extends AppComponentBase implements OnInit {
