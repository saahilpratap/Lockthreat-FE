...
import { BulkEditBusinessUnitComponent } from './organization-setup/business-unit/bulk-edit-business-unit/bulk-edit-business-unit-modal.component';
import { BulkEditEmployeesModalComponent } from './organization-setup/employees/bulk-edit-employees/bulk-edit-employees-modal.component';
import { BulkEditOrganizationEntitiesComponent } from './organization-setup/organization-entities/bulk-edit-organization-entities/bulk-edit-organization-entities-modal.component';
...
@NgModule({
  ...
  declarations: [
    ...
    CreateOrEditOrganizationEntitiesComponent,
    BusinessUnitComponent,
    CreateOrEditBusinessUnitComponent,
    EmployeesComponent,
    OrganizationSetupComponent,
    CreateOrEditEmployeesComponent,
    OrganizationEntitiesComponent,
    BulkEditBusinessUnitComponent,
    BulkEditEmployeesModalComponent,
    BulkEditOrganizationEntitiesComponent,
  ],
